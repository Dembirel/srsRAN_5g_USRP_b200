    ...
    if hasattr(os, "add_dll_directory"):
        ...
        if not uhd_dll_dir or not os.path.exists(os.path.join(uhd_dll_dir, uhd_dll_name)):
            ...
            if uhd_pkg_dir is not None and os.path.exists(
                ...
                UHD_INSTALL_PATH = "/home/dolaan/Desktop/учеба/диплом/srsRAN_5G/uhd-local"
        ...
        if uhd_dll_dir:
            ...
            UHD_VERSION = "4.9.0.HEAD-0-cfb98407"
...
try:
    ...
    def get_pkg_path():
        ...
        if env_path is not None and os.path.isdir(env_path):
            return env_path
        return "/home/dolaan/Desktop/учеба/диплом/srsRAN_5G/uhd-local"
    ...
    def get_pkg_data_path():
        ...
        if env_path is not None and os.path.isdir(env_path):
            return env_path
        return os.path.join("/home/dolaan/Desktop/учеба/диплом/srsRAN_5G/uhd-local", "share/uhd")

    __version__ = "4.9.0.HEAD-0-cfb98407"
